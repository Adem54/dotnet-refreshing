...
namespace GameStore.Api.Entities
{
    public class Game
    {
        ...
        public Genre Genre { get; set; }//this property may or may not be null depending on if we decide to populate generate when we read data from the database via at framework..sometimes it may be just enough to have the genreId so that will be populated but not the genre
